...
Neither of these can be discovered safely at call time. A profile with no calendar fails
with a caller on the line; missing Telnyx credentials fail *after* they have hung up, as a
